...
These images were captured from a disposable local Docker Compose stack using
the repository's real frontend and backend containers.

- `scene-management-sequence.png` shows the real editor with a temporary local
  four-point QR activation sequence.
